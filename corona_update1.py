...
def new_deaths(df):
    ...
    for ylb in ax.get_yticklabels():
        ...
        ylb.set_color(c)
    plt.tight_layout()
    plt.text(8, 600, f"World - {world['NewDeaths']}", fontsize=20, color='blue')
    plt.text(8, 450, f"{time.strftime('%d %b, %Y %I:%M %p')}", fontsize=20, color="#333333")
    plt.text(8, 300, f"India - {india['NewDeaths'].values[0]}", fontsize=20, color='green')
    plt.show()
...
def total_cases(df):
    ...
    for ylb in ax.get_yticklabels():
        ...
        ylb.set_color(c)
    plt.tight_layout()
    plt.text(18, 750000, f"World - {world['TotalCases']}", fontsize=20, color='blue')
    plt.text(18, 600000, f"{time.strftime('%d %b, %Y %I:%M %p')}", fontsize=20, color="#333333")
    plt.text(18, 450000, f"India - {india['TotalCases'].values[0]}", fontsize=20, color='green')
    plt.show()
...
def total_deaths(df):
    ...
    for ylb in ax.get_yticklabels():
        ...
        ylb.set_color(c)
    plt.tight_layout()
    plt.text(18, 45000, f"World - {world['TotalDeaths']}", fontsize=20, color='blue')
    plt.text(18, 35000, f"{time.strftime('%d %b, %Y %I:%M %p')}", fontsize=20, color="#333333")
    plt.text(18, 25000, f"India - {india['TotalDeaths'].values[0]}", fontsize=20, color='green')
    plt.show()
